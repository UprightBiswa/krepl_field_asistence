              ...
              child: SingleChildScrollView(
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: [
                      for (int i = 0; i < controller.customers.length; i++)
                        DataRow(
                          ...
                          cells: [
                            ...
                            DataCell(
                                Text(controller.customers[i].customerName)),
                            DataCell(
                                Text(controller.customers[i].customerNumber)),
                            DataCell(
                                Text(controller.customers[i].mobileNumber)),
                            DataCell(Text(controller.customers[i].villageName)),
                          ],
                        ),
                    ],
                  ),
