...
class BFilterBottomSheet extends StatelessWidget {
  final FormBController controller = Get.find<FormBController>();

  BFilterBottomSheet({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildPartyTypeButton("Village"),
              _buildPartyTypeButton("Doctor"),
              _buildPartyTypeButton("Farmer"),
            ],
          ),
  ...
  Widget _buildPartyTypeButton(String type) {
    return GestureDetector(
      onTap: () => controller.setPartyType(type),
      child: Obx(() => Chip(
            label: Text(type),
            labelStyle: TextStyle(
                color: controller.partyType.value == type
                    ? Colors.white
                    : Colors.black),
            backgroundColor: controller.partyType.value == type
                ? Colors.blue
                : Colors.grey[300],
